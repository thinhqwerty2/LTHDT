...
namespace QLPK.GUI.ThanhToan
{
    public partial class frmLapPhieuThuTienTamUng : Form
    {
        ...
        {
            PhieuThuTienTamUngDAO.Instance.themPhieuThuTienTamUng(Convert.ToDouble(txtTienTamUng.Text), DateTime.Now, MaBanKe, NguoiDung.TenDangNhap);
            MessageBox.Show("Tạm ứng thành công");
        }
    }
}
